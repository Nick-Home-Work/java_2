...
class Item{
  constructor(el, src = 'https://placehold.it/200x150'){
	this.product_name = el.product_name;
    this.price = el.price;
    this.id_product = el.id_product;
    this.src = el.src || 'https://placehold.it/200x150';
  }
  render(){
    return ``;
  }
...
class ProductItem extends Item{
  render() {
	  console.log('а вот и id  '+ this.id_product);
...
class CartItem extends Item{
  constructor(el, src = 'https://placehold.it/50x100'){
    super(el, src);
  ...
  render(){
    return `<div class="cart-item" data-id="${this.id_product}">
           ...
           <div class="product-desc">
            <b><p class="product-title">${this.product_name}</p></b>
            <p class="product-quantity">Количество: ${this.quantity}</p>
        <p class="product-single-price">${this.price} за ед.</p>
        </div>
        </div>
        <div class="right-block">
            <b><p class="product-price">${this.quantity*this.price} p<b></p>
            <button
			class="del-btn"
			data-id="${this.id_product}"><i class="fas fa-trash-alt"></i></button>
        </div>
        </div>`
  }
}
